package org.arcana.grimoire.navigation;
...
import org.arcana.grimoire.navigation.ViewUtils;
        ...
        if (attrs != null) {
            ...
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
                    icon = ta.getDrawable(R.styleable.BubbleToggleView_grimoire_icon);
                else
                icon = AppCompatResources.getDrawable(getContext(), ta.getResourceId(R.styleable.BubbleToggleView_grimoire_icon, R.drawable.default_icon));
                iconWidth = ta.getDimension(R.styleable.BubbleToggleView_grimoire_iconWidth, iconWidth);
                iconHeight = ta.getDimension(R.styleable.BubbleToggleView_grimoire_iconHeight, iconHeight);
                shape = ta.getDrawable(R.styleable.BubbleToggleView_grimoire_shape);
                shapeColor = ta.getColor(R.styleable.BubbleToggleView_grimoire_shapeColor, shapeColor);
                showShapeAlways = ta.getBoolean(R.styleable.BubbleToggleView_grimoire_showShapeAlways, false);
                title = ta.getString(R.styleable.BubbleToggleView_grimoire_title);
                titleSize = ta.getDimension(R.styleable.BubbleToggleView_grimoire_titleSize, titleSize);
                colorActive = ta.getColor(R.styleable.BubbleToggleView_grimoire_colorActive, colorActive);
                titleColorActive = ta.getColor(R.styleable.BubbleToggleView_grimoire_titleColorActive, colorActive);
                colorInactive = ta.getColor(R.styleable.BubbleToggleView_grimoire_colorInactive, colorInactive);
                isActive = ta.getBoolean(R.styleable.BubbleToggleView_grimoire_active, false);
                animationDuration = ta.getInteger(R.styleable.BubbleToggleView_grimoire_duration, DEFAULT_ANIM_DURATION);
                internalPadding = (int) ta.getDimension(R.styleable.BubbleToggleView_grimoire_padding, internalPadding);
                titlePadding = (int) ta.getDimension(R.styleable.BubbleToggleView_grimoire_titlePadding, titlePadding);
            } finally {
                ta.recycle();
            }
        }
